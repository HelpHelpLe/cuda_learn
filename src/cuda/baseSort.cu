...
__device__ void radix_sort(uint32_t *const sort_tmp, const uint32_t num_lists,
                           const uint32_t num_elements, const uint32_t tid,
...
__device__ void merge_array(const uint32_t *const src_array,
                            uint32_t *const des_array, const uint32_t num_lists,
                            const uint32_t num_elements, const uint32_t tid) {
...
__host__ void gpu_sort(uint32_t *const data, const uint32_t num_elements) {
    uint32_t *gpu_data;
    ...
    gpu_sort_array_array<<<1, MAX_NUM_LISTS>>>(gpu_data, MAX_NUM_LISTS,
                                               num_elements);
